...
declare module BP3D.Core {
    ...
    class GeometryUtils {
         ...
         */
        static getPointDistanceFromLine(x: number, y: number, x1: number, y1: number, x2: number, y2: number): number;
         ...
         * @returns The point.
         */
        static getClosestPointOnLine(x: number, y: number, x1: number, y1: number, x2: number, y2: number): {
            x: number;
            y: number;
        };
        ...
        static getAngle2pi(x1: number, y1: number, x2: number, y2: number): number;
        ...
        static getPolygonPolygonIntersect(firstCorners: any, secondCorners: any): boolean;
        /** Corners is an array of points with x,y attributes */
        static getLinePolygonIntersect(x1: number, y1: number, x2: number, y2: number, corners: any): boolean;
        /** */
        static getLineLineIntersect(x1: number, y1: number, x2: number, y2: number, x3: number, y3: number, x4: number, y4: number): boolean;
        /**
        ...
        */
        static getPointInPolygon(x: number, y: number, corners: any, startX?: number, startY?: number): boolean;
        /** Checks if all corners of insideCorners are inside the polygon described by outsideCorners */
        static getPolygonInsidePolygon(insideCorners: any, outsideCorners: any, startX: number, startY: number): boolean;
        /** Checks if any corners of firstCorners is inside the polygon described by secondCorners */
        static getPolygonOutsidePolygon(insideCorners: any, outsideCorners: any, startX: number, startY: number): boolean;
        static forEach(array: any, action: any): void;
        static forEachIndexed(array: any, action: any): void;
        static getMap(array: any, func: any): any[];
        ...
        static getCycle(arr: any, shift: any): any;
        /** Returns in the unique elemnts in arr */
        static getUnique(arr: any, hashFunc: any): any[];
        ...
        static getSubtract(array: any, subArray: any): any[];
    }
}
declare module BP3D.Core {
    ...
    class Dimensioning {
         ...
         */
        static centimetersToDisplayString(cm: number): string;
    }
}
declare module BP3D.Core {
...
declare module BP3D.Model {
    ...
    class Scene {
        ...
        /** Item */
        private onItemLoadedCallbacks;
        /** Item */
        private onItemRemovedCallbacks;
        /**
         * Constructs a scene.
...
declare module BP3D.Floorplanner {
    ...
    class Floorplanner {
        ...
        private wallWidth;
        /** */
        private onModeResetCallbacks;
        /** */
        private plannerCanvas;
        /** */
        private view;
        /** */
        private mouseDown;
